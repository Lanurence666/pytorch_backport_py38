...
from typing import Any, Dict, List, Literal, Set, TYPE_CHECKING, Tuple, TypeVar, Union
...
def parse_native_yaml_struct(
    es: object,
    valid_tags: Set[str],
    ignore_keys: Union[Set[DispatchKey], None] = None,
    path: str = "<stdin>",
...
def parse_native_yaml(
    ...
    *,
    skip_native_fns_gen: bool = False,
    loaded_yaml: Union[object, None] = None,
) -> ParsedYaml:
...
def compute_meta_function_declaration(g: NativeFunctionsGroup) -> Union[str, None]:
    if not g.structured:
        return None
...
def get_custom_build_selector(
    provided_op_registration_allowlist: Union[List[str], None],
    op_selection_yaml_path: Union[str, None],
) -> SelectiveBuilder:
    if (
    ...
    op_registration_allowlist: Union[Set[str], None] = None
...
def gen_source_files(
    *,
    ...
    aoti_backends: Set[Union[DispatchKey, None]],
...
#include <ATen/hip/HIPContext.h>"""
    ...
    for dispatch_key in dispatch_keys:
        ...
        def register_dispatch_key_env_callable(
            gnf: Union[NativeFunction, NativeFunctionsGroup],
        ) -> Dict[str, List[str]]:
            return {
