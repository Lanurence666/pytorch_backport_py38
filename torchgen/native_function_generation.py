...
def get_expected_out_variant_overload_name(overload_name: Union[str, None]) -> str:
...
def gen_composite_functional_kernel(g: NativeFunctionsGroup) -> Union[str, None]:
...
# We only do this for "generated" NativeFunctions
@with_native_function
def gen_composite_out_kernel(g: NativeFunctionsGroup) -> Union[str, None]:
    # We should only be generating these for code-generated NativeFunctions
