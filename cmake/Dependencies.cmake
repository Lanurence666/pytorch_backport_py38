...
if(BUILD_TEST OR BUILD_MOBILE_BENCHMARK OR BUILD_MOBILE_TEST)
  ...
  set(BENCHMARK_ENABLE_REGEX_TESTS OFF CACHE BOOL "Disable benchmark regex tests.")
...
if(USE_DISTRIBUTED AND USE_GLOO AND MSVC)
  add_compile_options(-DTORCH_USE_LIBUV)
  set(TEMP_BUILD_SHARED_LIBS ${BUILD_SHARED_LIBS})
  set(BUILD_SHARED_LIBS OFF CACHE BOOL "Build shared libs" FORCE)
  set(LIBUV_BUILD_SHARED OFF CACHE BOOL "" FORCE)
  set(LIBUV_BUILD_TESTS OFF CACHE BOOL "" FORCE)
  set(BUILDING_LIBUV ON CACHE BOOL "" FORCE)
  set(LIBUV_INSTALL OFF CACHE BOOL "" FORCE)
  add_subdirectory(${PROJECT_SOURCE_DIR}/third_party/tensorpipe/third_party/libuv)
  set(BUILD_SHARED_LIBS ${TEMP_BUILD_SHARED_LIBS} CACHE BOOL "Build shared libs" FORCE)
  include_directories(BEFORE SYSTEM ${PROJECT_SOURCE_DIR}/third_party/tensorpipe/third_party/libuv/include)
  list(APPEND Caffe2_DEPENDENCY_LIBS uv_a)
  set(libuv_DLL_PATH "" CACHE FILEPATH "" FORCE)
endif()
