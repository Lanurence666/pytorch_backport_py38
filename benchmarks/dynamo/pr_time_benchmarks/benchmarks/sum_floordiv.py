...
class Benchmark(BenchmarkBase):
    ...
    def _work(self):
        ...
        with torch._dynamo.config.patch("enable_cpp_symbolic_shape_guards", False), torch._export.config.patch(use_new_tracer_experimental=True), CompileTimeInstructionCounter.record():
