...
from typing import Dict, Iterator, List, Sequence, TYPE_CHECKING, Tuple, Type, Union
...
) -> Union[Dict[Var, object], bool]:  # no check at the moment
...
def unify(u: object, v: object) -> Union[Dict[Var, object], bool]:
    return unify(u, v, {})
