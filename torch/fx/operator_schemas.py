...
from typing import Any, Callable, Dict, Generator, List, Optional, TYPE_CHECKING, Tuple, Type, Union, cast, overload
...
) -> Optional[Tuple[List[inspect.Signature]], Optional[List[torch._C.FunctionSchema]]]: ...
