...
import sys
import warnings
from typing import Optional, Sequence, TYPE_CHECKING, Tuple, Type, Union, cast
...
def _slice(
    ...
    axes: Union[Union[list, torch.Tensor], torch._C.Value],
    starts: Union[Union[list, torch.Tensor], torch._C.Value],
    ends: Union[Union[list, torch.Tensor], torch._C.Value],
    steps: Union[Union[list, torch.Tensor], torch._C.Optional[Value]] = None
):
