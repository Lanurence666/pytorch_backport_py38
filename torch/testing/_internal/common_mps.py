...
if torch.backends.mps.is_available():
    ...
    def mps_ops_modifier(
        ...
        UNIMPLEMENTED_XFAILLIST: Union[Dict[str, list, None]]= {
        ...
        UNIMPLEMENTED_XFAILLIST_SPARSE: Union[Dict[str, list, None]]= {
            "logspace": None,
            "logspacetensor_overload": None,
            "linalg.eig": None,
            "linalg.eigvals": None,
        ...
        UNDEFINED_XFAILLIST: Union[Dict[str, list, None]]= {
            # Top 60 operators
        ...
        ON_MPS_XFAILLIST: Union[Dict[str, list, None]]= {
