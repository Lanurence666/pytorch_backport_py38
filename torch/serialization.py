...
import threading
import warnings
from typing import Any, Callable, Dict, Generic, IO, List, Optional, Set, Tuple, Type, TypeVar, Union, cast, overload
...
def location_tag(
    storage: Union[Union[Storage, torch.storage.TypedStorage], torch.UntypedStorage],
):
