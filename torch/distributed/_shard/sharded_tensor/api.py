...
from typing import Callable, Dict, List, Optional, Sequence, Set, TYPE_CHECKING, Tuple, Type, Union, cast, overload
...
class ShardedTensor(ShardedTensorBase):
    ...
    def _init_from_local_shards(
        ...
        *global_size,
        ...
        gathered_metadatas: Union[List[ShardedTensorMetadata, None]]= []
        if world_size > 1:
