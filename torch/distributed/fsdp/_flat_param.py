...
from typing import Any, Callable, Dict, Generator, Iterator, List, Optional, Sequence, Set, Tuple, Union, cast, no_type_check, overload
...
class FlatParameter(nn.Parameter, metaclass=_FlatParameterMeta):
    ...
    _tensors: Optional[List[Union[Tensor, None]]]
