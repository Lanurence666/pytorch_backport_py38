...
from typing import Any, Callable, List, Optional, TYPE_CHECKING, Tuple, Type, TypeVar, Union, overload
try:
...
def _std_var(
    ...
    *,
    correction_opt: Union[int, Optional[float]],
