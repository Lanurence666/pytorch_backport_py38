...
from typing import Any, Callable, Dict, FrozenSet, List, Optional, Set, TYPE_CHECKING, Tuple, Type, Union
...
@functools.lru_cache
def get_global_source_name(source: Optional[Source]) -> Optional[str]:
    if isinstance(source, ChainedSource):
