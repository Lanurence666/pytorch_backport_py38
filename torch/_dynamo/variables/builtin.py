...
from typing import Any, Callable, Dict, FrozenSet, Iterable, List, Optional, Sequence, Set, TYPE_CHECKING, Tuple, Type, Union, cast
...
_HandlerCallback = Callable[
    ["InstructionTranslator", typing.Any, typing.Any], Optional[VariableTracker]
]
...
def populate_builtin_to_tensor_fn_map() -> None:
    ...
    if len(BUILTIN_TO_TENSOR_FN_MAP) > 0:
        ...
        # repopulate
        return
    most_recent_func: Optional[Callable[..., Any]] = None
...
class BuiltinVariable(BaseBuiltinVariable):
    ...
    ) -> Optional[List[_HandlerCallback]]:
    ...
    def nb_or_impl(
        ...
        # _Py_union_type_or for type unions (e.g. Union[list, tuple]).
    ...
    def _call_min_max_binary(
        self,
        tx: "InstructionTranslator",
        a: Optional[VariableTracker],
        b: Optional[VariableTracker],
    ) -> Optional[VariableTracker]:
    ...
    def _call_iter_tuple_list(
        self,
        tx: "InstructionTranslator",
        obj: Optional[VariableTracker] = None,
        *args: VariableTracker,
        **kwargs: VariableTracker,
    ) -> Optional[VariableTracker]:
