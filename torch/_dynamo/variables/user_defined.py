...
from typing import Any, Callable, Dict, FrozenSet, Iterable, List, MutableMapping, Optional, Sequence, Set, TYPE_CHECKING, Tuple, Type, Union
...
class UserDefinedClassVariable(UserDefinedVariable):
    ...
    def call_function(
        ...
        if self.can_constant_fold_through() and constant_args:
            ...
            def deque_signature(
                iterable: Optional[Iterable[Any]]= None, maxlen: Optional[int] = None
            ) -> Any:
                pass
...
class UserDefinedObjectVariable(UserDefinedVariable):
    ...
    _base_vt: Optional[VariableTracker]= None
    ...
    _base_methods: Optional[Set[Any]]= None
    ...
    def __init__(
        ...
        *,
        ...
        cls_source: Optional[TypeSource]= None,
        base_cls_vt: Optional[VariableTracker]= None,
        init_args: Optional[Sequence[VariableTracker]]= None,
        **kwargs: Any,
    ) -> None:
        super().__init__(**kwargs)
        self.value = value
        ...
        self.dict_vt: Optional[DunderDictVariable] = None
    ...
    def SLOT1BIN(
        ...
        #
        # TESTFUNC == slot_nb_or (for Union[the, operator]), so this is basically
        ...
        # equivalent to calling a.__or__(b) directly, NOT Union[a, b], which would
    ...
    def generic_getattr(
        ...
        """
        source: Optional[Source]= AttrSource(self.source, name) if self.source else None
        ...
        # them.
        if name == "__class__":
            cls_source: Optional[Source]= source
            if source is None:
    ...
    def var_getattr(self, tx: "InstructionTranslator", name: str) -> VariableTracker:
        if self._object_has_getattribute:
            ...
            new_source: Optional[AttrSource]= (
...
class UserDefinedExceptionObjectVariable(UserDefinedObjectVariable):
    ...
    @property
    def python_stack(self) -> Optional[traceback.StackSummary]:
...
class UserDefinedDictVariable(UserDefinedObjectVariable):
    ...
    def __init__(
        self,
        value: object,
        dict_vt: Optional[ConstDictVariable]= None,
        **kwargs: Any,
    ) -> None:
        super().__init__(value, **kwargs)
        if dict_vt is None:
...
class OrderedDictVariable(UserDefinedDictVariable):
    ...
    def __init__(
        self,
        value: object,
        dict_vt: Union["ConstDictVariable, None"]= None,
        **kwargs: Any,
    ) -> None:
        if dict_vt is None:
...
class UserDefinedSetVariable(UserDefinedObjectVariable):
    ...
    def __init__(
        self, value: object, set_vt: Optional[SetVariable] = None, **kwargs: Any
    ) -> None:
        from .builder import SourcelessBuilder
...
class UserDefinedTupleVariable(UserDefinedObjectVariable):
    ...
    def _validate_rest_for_tree_map(
        self, rest: "Sequence[VariableTracker]"
    ) -> Optional[List["UserDefinedTupleVariable"]]:
