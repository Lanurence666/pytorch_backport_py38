...
STATIC_LOWER_FUNCTIONAL_MAP: Union[Dict[Callable, Tuple[Callable, Callable, None]]]= {
...
QBIN_OP_MAPPING: Union[Dict[Callable, str, Callable]]= {
...
QBIN_RELU_OP_MAPPING: Union[Dict[Callable, str, Callable]]= {
