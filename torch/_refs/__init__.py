...
from typing import Any, Callable, Dict, Iterable, List, Optional, Sequence, Tuple, Type, Union, cast, overload
...
def sum(
    a: TensorLikeType,
    dim: Union[int, Optional[List[int]]]= None,
    keepdim: bool = False,
    *,
    dtype: Optional[torch.dtype] = None,
    out: Optional[Tensor] = None,
...
def view(a: TensorLikeType, *shape: Union[ShapeType, Tuple[ShapeType]]) -> TensorLikeType:
    ...
    # Tuple[Union[ShapeType, Tuple[ShapeType]], ...] but the function expects
