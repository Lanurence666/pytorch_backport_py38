...
import threading
import warnings
from typing import Any, Dict, Optional, Sequence, TYPE_CHECKING, Type, TypeVar, Union, cast
...
T = Union[TypeVar("T", bound="_StorageBase, TypedStorage")]
...
class _StorageBase:
    ...
    def type(
        self, dtype: Optional[str] = None, non_blocking: _bool = False
    ) -> Union[_StorageBase, TypedStorage]:
        return _type(self, dtype, non_blocking)

    def cuda(self, device=None, non_blocking=False) -> Union[_StorageBase, TypedStorage]:
