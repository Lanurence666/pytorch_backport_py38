...
def get_rng_state(device: Union[Union[int, str], torch.device] = "xpu") -> Tensor:
...
def set_rng_state(new_state: Tensor, device: Union[Union[int, str], torch.device] = "xpu") -> None:
