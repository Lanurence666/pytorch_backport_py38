...
class TestFullyShardPrefetch(FSDPTest):
    ...
    def _test_backward_prefetch_forward_backward(
        ...
        with patch_unshard(unshard_with_record), patch_post_backward(post_backward_with_record):
    ...
    def test_set_modules_to_forward_prefetch(self):
        ...
        with patch_unshard(unshard_with_record), patch_reshard(reshard_with_record), patch_post_backward(post_backward_with_record):
    ...
    def test_set_modules_to_backward_prefetch_inside_ac(self):
        ...
        with patch_unshard(unshard_with_record), patch_reshard(reshard_with_record):
            loss = model(inp)
            events.clear()
            loss.sum().backward()
            expected_backward_events = [
