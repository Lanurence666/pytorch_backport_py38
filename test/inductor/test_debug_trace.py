...
class TestDebugTrace(test_torchinductor.TestCase):
    def test_debug_trace(self):
        ...
        with config.patch(
            ...
            with self.assertLogs( logging.getLogger("torch._inductor.debug"), level=logging.WARNING ) as cm, ctx():
...
op2.node.kernel = extern_kernels.mm""",
    ...
    def test_debug_multi_tempalte(self):
        ...
        # no failure
        with self.assertLogs( logging.getLogger("torch._inductor.debug"), level=logging.WARNING, ), fresh_cache():
