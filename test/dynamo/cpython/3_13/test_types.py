...
class SimpleNamespaceTests(CPythonTestCase):
    ...
    def test_replace(self):
        ...
        self.assertEqual(vars(_copy_replace_compat(ns, x=1)), {'x': 1, 'y': 22})
        self.assertEqual(vars(_copy_replace_compat(ns, y=2)), {'x': 4, 'y': 2})
        self.assertEqual(vars(_copy_replace_compat(ns, x=1, y=2)), {'x': 1, 'y': 2})
    ...
    def test_replace_subclass(self):
        ...
        spam = Spam(ham=8, eggs=9)
        spam2 = _copy_replace_compat(spam, ham=5)
