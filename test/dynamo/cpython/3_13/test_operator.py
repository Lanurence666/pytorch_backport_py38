...
class OperatorTestCase:
    ...
    def test_call(self):
        ...
        self.assertEqual(_operator_call_compat(func), ((), {}))
        self.assertEqual(_operator_call_compat(func, 0, 1), ((0, 1), {}))
        self.assertEqual(_operator_call_compat(func, a=2, obj=3),
                         ((), {"a": 2, "obj": 3}))
        self.assertEqual(_operator_call_compat(func, 0, 1, a=2, obj=3),
                         ((0, 1), {"a": 2, "obj": 3}))
