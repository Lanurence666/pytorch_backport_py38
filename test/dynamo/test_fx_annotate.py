...
('call_function', 'getitem_5', {'compile_inductor': 0})""",
    ...
    def test_flex_attention_backward_tag_does_not_leak(self):
        ...
        with torch._dynamo.config.patch(error_on_nested_fx_trace=False), torch.compiler._non_strict_tracing_context(), torch.compiler._patch_autograd_grad(), preserve_node_meta():
