...
class GraphModule(torch.nn.Module):
    ...
    def test_local_map_dynamo_mismatch_placements(self):
        ...
        with LocalMapWrappedHigherOrderVariable.enable(), self.assertRaisesRegex( AssertionError, "Expecting 1 inputs to local_map function based on placements, but found 2.", ):
        ...
        x = torch.randn(64, 64, 64, requires_grad=True)
        with LocalMapWrappedHigherOrderVariable.enable(), self.assertRaisesRegex( AssertionError, "Expecting 1 outputs to local_map function based on placements, but found 2.", ):
    ...
    def test_local_map_dynamo_reordered_inputs(self):
        ...
        with LocalMapWrappedHigherOrderVariable.enable(), self.assertRaisesRegex( AssertionError, r"Dynamo changed the order of inputs to the local_map function, please adjust the order of inputs and input_placements from \[l_args_0_, l_args_1_\], to: \[l_args_1_, l_args_0_\].*", ):
