...
class SPVGenerator:
    ...
    def generateVariantCombinations(
        ...
        exclude_params: Union[Set[str], None] = None,
    ) -> List[Any]:
    ...
    def create_shader_params(
        self, variant_params: Union[Dict[str, Any], None] = None
    ) -> Dict[str, str]:
...
class ShaderInfo:
    ...
    register_for: Union[Tuple[str, List[str]], None] = None
