...
def parse_arguments(
    parser: argparse.ArgumentParser,
) -> Tuple[Option, Union[List[str], None], Union[List[str], None], Union[bool, None]]:
    # parse args
...
def get_test_list_by_type(run_only: Union[List[str], None], test_type: TestType) -> TestList:
    test_list: TestList = []
...
def get_test_list(run_only: Union[List[str], None]) -> TestList:
    test_list: TestList = []
    # add c++ test list
...
def empty_list_if_none(arg_interested_folder: Union[List[str], None]) -> List[str]:
...
def get_python_run_only(args_run_only: Union[List[str], None]) -> List[str]:
